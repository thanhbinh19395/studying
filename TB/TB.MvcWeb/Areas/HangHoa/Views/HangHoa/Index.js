framework.factory('binhtest', {
        ...
        header.title()
            ...
            .addRight({
                ...
                type: 'button', id: 'btn-test2', caption: 'Multiple Popup', icon: 'fa-rocket', onClick: function () {
                    self.openPopup({ name: 'multiplePopup', url: '/Documents/Home/ListPerson', title: 'Multiple Popup', width: 800, resizable: true, openMultiple: true });
                }
            })
        ;
    },
    onInitContent: function (content) {
        ...
        grid.setName('grid1')
            ...
            .addButton('btnDelete', 'Xoa', 'glyphicon-remove', self.onbtnXoaClickGrid1.bind(this))
            .setRowExpandHandler(self.onrowExpand.bind(this))
            //.addRecords(data.Data) // du lieu random tu controller
